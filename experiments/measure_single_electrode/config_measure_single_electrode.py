...
class experiment_config(config_class):
    ...
    def __init__(self):
        ...
        self.measure_electrode = 6  # 0-7
        self.control_sequence = np.zeros((1, 8))
        self.control_sequence[0] = [611,611,-217,-206,166,146,148, 0]
        ...
        # Save settings
        self.filepath = r'D:\Data\BramdW\D9\measure_single_electrode\\'  #Important: end path with double backslash
        self.name = ['XOR']
