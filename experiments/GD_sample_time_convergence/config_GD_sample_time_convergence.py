...
class experiment_config(config_class):
    ...
    def __init__(self):
        ...
        self.name = 'CV_11_30_1948_T_005-10s_fs_5x2-23Hz_inverse_f2_f3_inverse_freqs_low_amp'
        ...
        self.filepath =  r'D:\\data\\Mark\\GD\\convergence\\'
    ...
    def lock_in_gradient(self, output, freq, A_in, fs=1000, phase_thres=90): 
        ...
        t = np.arange(0,output.shape[0]/fs,1/fs)[:output.shape[0]]
