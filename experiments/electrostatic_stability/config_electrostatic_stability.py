...
class experiment_config(config_class):
    ...
    def __init__(self):
        ...
        self.fieldPoints =  2  # Amount of voltages between high and low
        self.fieldRepeat = 100  # Amount of measurements per field value
        ...
        # Save settings
        self.filepath = r'D:\\data\\BramdW\\electrostatic_stability\\'
        self.name = 'electrostatic_stability'
