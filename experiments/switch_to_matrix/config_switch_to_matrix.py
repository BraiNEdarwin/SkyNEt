...
class experiment_config(config_class):
    ...
    def matrix(self):
        ...
        connect_matrix[0,:] = [0, 0, 0, 0, 0, 0, 0, 1] ## C1 connects to e1 of D(fill in)
        connect_matrix[1,:] = [0, 0, 0, 0, 1, 0, 0, 0] ## C2 connects to e2 of D(fill in)
        connect_matrix[2,:] = [1, 1, 0, 0, 0, 0, 0, 0] ## C3 connects to e3 of D(fill in)
        connect_matrix[3,:] = [1, 0, 0, 1, 0, 0, 0, 0] ## C4 connects to e4 of D(fill in)
        connect_matrix[4,:] = [0, 0, 1, 0, 0, 0, 0, 0] ## C5 connects to e5 of D(fill in)
        connect_matrix[5,:] = [1, 0, 0, 0, 0, 0, 0, 0] ## C6 connects to e6 of D(fill in)
        connect_matrix[6,:] = [0, 0, 0, 0, 0, 1, 0, 0] ## C7 connects to e7 of D(fill in)
        connect_matrix[7,:] = [0, 0, 0, 0, 0, 0, 1, 0] ## C8 connects to e8 of D(fill in)
